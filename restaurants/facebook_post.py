...
if __name__ == '__main__':
    ...
    image_url = "https://www.google.com/imgres?imgurl=https%3A%2F%2Fi.ytimg.com%2Fvi%2F2-rshIaBVJg%2Fmaxresdefault.jpg&imgrefurl=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3D2-rshIaBVJg&docid=coOAH2SWY6L0qM&tbnid=dwfo63HM2340XM%3A&vet=10ahUKEwig1uC6_oznAhXRpOkKHQFiDN4QMwh5KAAwAA..i&w=1280&h=720&bih=657&biw=1366&q=asdf&ved=0ahUKEwig1uC6_oznAhXRpOkKHQFiDN4QMwh5KAAwAA&iact=mrc&uact=8"
    my_name = 'Vipul Krishna Mathuria'

    message = my_name + ' @Vipul Krishna Mathuria likes this ice-cream! and he executed file on 1:25 PM'
    facebook.publish_photo_msg(message, image_url)
# python3 share_review.py --image /path/to/image.jpg --message 'this is NAME’s favourite ice-cream!'
